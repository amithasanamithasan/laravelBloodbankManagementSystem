...
<head>
    ...
    <nav class="navbar navbar-blue navbar-expand-md navigation-clean-search" style="background-color:#000000;">
...
<div class="footer-dark" style="background-color:rgb(0,0,0);">
    ...
    <div class="col item social">
        <a href="https://github.com/amithasanamithasan"><i class="icon ion-social-github-outline"></i></a>
        <a href="https://www.linkedin.com/in/amit-hasan-24950522a/"><i class="icon ion-social-linkedin-outline"></i></a>
        <a href="https://www.facebook.com/amithasan"><i class="icon ion-social-facebook-outline"></i></a>
        <a href=""><i class="icon ion-social-twitter-outline"></i></a>
        <a href=""><i class="icon ion-social-instagram-outline"></i></a>
    </div>
    <p class="copyright" style="font-size:15px;padding-top:10px;">Amit Hasan FAysal, 📧 amit35-1773@diu.bd © <?php echo date("Y"); ?>  </p>
